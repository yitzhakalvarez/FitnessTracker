...
<div class="calendar is-calendar-large">
  ...
  <div class="calendar-container">
    ...
    <div class="calendar-body">
      <div class="calendar-date disabled"><button class="date-item">29</button></div>
      ...
      <div class="calendar-date"><button class="date-item is-active">3</button></div>
      ...
      <div class="calendar-date tooltip" data-tooltip="You have appointments">
        ...
        <div class="calendar-events">
          <a class="calendar-event is-primary">Meeting</a>
          <a class="calendar-event is-warning">2nd Meeting</a>
          <a class="calendar-event is-danger">3rd Meeting</a>
        </div>
      </div>
      ...
      <div class="calendar-date calendar-range range-start"><button class="date-item is-active">24</button>
      <div class="calendar-events">
          <a class="calendar-event is-success">CHRISTMAS <br> BREAK</a>
        </div>
    </div>
      <div class="calendar-date calendar-range"><button class="date-item">25</button>
            <div class="calendar-events">
          <a class="calendar-event is-success">CHRISTMAS <br> BREAK</a>
        </div>
        </div>
      <div class="calendar-date calendar-range"><button class="date-item">26</button>
            <div class="calendar-events">
          <a class="calendar-event is-success">CHRISTMAS <br> BREAK</a>
        </div>
        </div>
      <div class="calendar-date calendar-range"><button class="date-item">27</button>
            <div class="calendar-events">
          <a class="calendar-event is-success">CHRISTMAS <br> BREAK</a>
        </div>
        </div>
      <div class="calendar-date calendar-range"><button class="date-item">28</button>
            <div class="calendar-events">
          <a class="calendar-event is-success">CHRISTMAS <br> BREAK</a>
        </div>
        </div>
      <div class="calendar-date calendar-range"><button class="date-item">29</button>
            <div class="calendar-events">
          <a class="calendar-event is-success">CHRISTMAS <br> BREAK</a>
        </div>
        </div>
      <div class="calendar-date calendar-range"><button class="date-item">30</button>
            <div class="calendar-events">
          <a class="calendar-event is-success">CHRISTMAS <br> BREAK</a>
        </div>
        </div>
      <div class="calendar-date calendar-range range-end"><button class="date-item is-active">31</button>
            <div class="calendar-events">
          <a class="calendar-event is-success">CHRISTMAS <br> BREAK</a>
        </div>
        </div>
      <div class="calendar-date disabled">
        ...
        <div class="calendar-events">
          <a class="calendar-event">HAPPY NEW <br> YEARS</a>
        </div>
      </div>
    </div>
  </div>
