           ...
           <div class = "column is-two-thirds">
                      ...
                      <div class = "field" v-if="addfriendid == 1">
                        ...
                        <div class="control" v-if="addfriendid == 1">
                         <label class="label">After you hit the add friend button hit the view friends button to look at your list of friends:</label>
              ...
              <div class = "column is-one-third">
                  <div class="control">
                      <router-link to="/friendlist"  class="button is-rounded is-dark">View your friends</router-link>
                  </div>
              </div>
        </div>
    </div>
