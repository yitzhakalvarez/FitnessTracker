      ...
      <div class="columns is-centered">
        <div class="column is-5-tablet is-4-desktop is-3-widescreen">
          <form action="" class="box" @submit.prevent="login">
            ...
            <div class="control">
              <button class="button is-primary is-medium" @click.prevent="fbLogin">FB-Login</button>
            </div>
            <div class="control">
              <button class="button is-primary is-medium" @click.prevent="googleLogin">Google Login</button>
            </div>
            <div class="control">
